...
namespace BehaviorDesigner.Runtime.Tasks.Movement
{
    ...
    public class CanSeeObject : Conditional
    {
        ...
        public SharedBool seenThePlayer;
        public SharedBool chaseThePlayer;
        public SharedBool findThePlayer;
...
public override TaskStatus OnUpdate()
        {
            ...
            {
                targetObject = GameController.Instance.Player.gameObject;
            }
            ...
            if (returnedObject.Value != null) {
                ...
                seenThePlayer.Value = true;
                chaseThePlayer.Value = true;
                findThePlayer.Value = true;
                return TaskStatus.Success;
            }
            // An object is not within sight so return failure
            seenThePlayer.Value = false;
