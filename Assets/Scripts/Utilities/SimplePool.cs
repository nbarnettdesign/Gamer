...
public static class SimplePool
{
    ...
    class Pool
    {
        ...
        public void Despawn(GameObject obj, bool deparent = false)
        {
            obj.SetActive(false);
    ...
    {
        // Extention to ensure that arrows are cleaned up correctly when an object is turned off
        foreach (Transform child in obj.transform)
        {
            Arrow arrow = child.GetComponent<Arrow>();

            if (arrow == null)
                arrow = child.GetComponentInChildren<Arrow>();
