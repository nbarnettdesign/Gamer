...
namespace Valve.VR.InteractionSystem {
	public class VelocityEstimator : MonoBehaviour {
		...
		[SerializeField] private int velocityAverageFrames = 5;
		[Tooltip("How many frames to average over for computing angular velocity")]
		[SerializeField] private int angularVelocityAverageFrames = 11;

		[SerializeField] private bool estimateOnAwake = false;
