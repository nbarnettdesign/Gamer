...
namespace Valve.VR.InteractionSystem {
	public class CircularDrive : Interactable {
		public enum Axis_t { XAxis, YAxis, ZAxis }

		[Tooltip("The axis around which the circular drive will rotate in local space")]
		[SerializeField] private Axis_t axisOfRotation = Axis_t.XAxis;
		...
		[SerializeField] private Collider childCollider = null;
		...
		[SerializeField] private bool hoverLock = false;
		...
		[SerializeField] private Vector2 frozenDistanceMinMaxThreshold = new Vector2(0.1f, 0.2f);
		[SerializeField] private UnityEvent onFrozenDistanceThreshold;
		...
		[SerializeField] private bool freezeOnMin = false;
		...
		[SerializeField] private bool freezeOnMax = false;
		...
		[SerializeField] private bool rotateGameObject = true;
		...
		[SerializeField] private bool deactivateAfterStart;
